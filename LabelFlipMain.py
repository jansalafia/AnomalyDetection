...
# --- CONFIG ---
POISONED_CSV = "CSVs/newDataset_poisoned_30.csv"

RESULT_PATHS = {
    "LogReg":       "Results/LogRegResults/results_logreg_poisoned_30.csv",
    "NeuralNet":    "Results/NeuralNetworksResults/results_neuralnet_poisoned_30.csv",
    "RandomForest": "Results/RandomForestResults/results_randomforest_poisoned_30.csv",
    "SVM":          "Results/SVMResults/results_svm_poisoned_30.csv",
    "XGBoost":      "Results/XGBoostResults/results_xgboost_poisoned_30.csv",
}
